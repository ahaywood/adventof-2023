...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-x-5 lg:gap-x-2 xl:gap-x-5">
	...
	<div class="tier">
		...
		<h3>Bundled with JS & CSS Challenges</h3>
		<p>
			All 24 Testing challenges and their solutions. PLUS 24 CSS challenges and their solutions from <a
				href="https://adventofcss.com">Advent of CSS</a
			>.
		</p>
...
<style lang="postcss">
	...
	.dollar {
		@apply font-script text-5xl relative -top-5;
	}

	.number {
		@apply font-slabSerif text-5xl;
	}

	h3 {
		@apply uppercase font-slabSerif text-base text-center mb-5;
	}
</style>
